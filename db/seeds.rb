...
katzencafé = Company.create(name: 'Katzencafé', statement: '', url: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1027&q=80', email: 'katzen@cafe.com', description: '', headquarters: 'Brrr')
...
puts "creating jobs..."
job_one = Job.create!(title: 'Head Of Finances', category: 'design', applying: '#', description: 'What we need and what you have:
